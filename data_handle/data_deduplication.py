...
def remove_duplicate_rows(input_file, output_file):
    ...
    print("产率:%.3f%%" % (df.shape[0]*100.0/original_rows))
    print(f"结果已保存到: {output_file}")


# 使用示例
if __name__ == "__main__":
    input_filename = "house_data_7.xlsx"  # 请修改为你的输入文件名
    output_filename = "house_cleared_7.xlsx"  # 请修改为你想要的输出文件名
